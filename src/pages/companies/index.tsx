...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'access_right.count', 'car.count', 'invitation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('access_right', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'access_right',
          header: 'Access Right',
          accessorKey: 'access_right',
          cell: ({ row: { original: record } }: any) => record?._count?.access_right,
        }
      : null,
    hasAccess('car', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Car',
          accessorKey: 'car',
          cell: ({ row: { original: record } }: any) => record?._count?.car,
        }
      : null,
