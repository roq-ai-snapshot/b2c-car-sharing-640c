...
import { getAccessRightById } from 'apiSdk/access-rights';
import { AccessRightInterface } from 'interfaces/access-right';

function AccessRightViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('access_right', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/access-rights/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Access Level" text={data?.access_level} />
